                ...
                base64.encode(rootPath+'Requisicao_'+requisicao.id+'.zip', function(err, base64String) {  
                  ...
                  db.sequelize.query(query, {type:db.Sequelize.QueryTypes.BULKUPDATE}).then(function(reqUpdate) {
                    configuration.findById(1).then(function (configuration) {
                      ...
                      var toEmail = requisicao.email+ ";projeta@inpe.br";
                      ...
                      conteudo += "<br>Quando os dados forem utilizados para trabalhos acadêmicos e publicações, utilizar nas referências bibliográficas a fonte dos dados CPTEC/INPE da seguinte forma “Dados gerados pelo CPTEC/INPE e disponibilizados na Plataforma PROJETA” e as referências bibliográficas:<br>";
